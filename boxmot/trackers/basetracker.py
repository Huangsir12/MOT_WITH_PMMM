...
class BaseTracker(ABC):
    ...
    def per_class_decorator(update_method):
        ...
        """
        def wrapper(self, dets: np.ndarray, img: np.ndarray, embs: np.ndarray = None, img_width: int = 1920, img_height: int = 1080):
            ...
            if self.per_class:
                ...
                return update_method(self, dets=dets, img=img, embs=embs, img_width=img_width, img_height=img_height)
        return wrapper
