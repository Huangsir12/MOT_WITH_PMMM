...
class BotSort(BaseTracker):
    ...
    def update(self, dets: np.ndarray, img: np.ndarray, embs: np.ndarray = None, img_width: int = 1920, img_height: int = 1080) -> np.ndarray:
        ...
        return self._prepare_output(activated_stracks, refind_stracks, lost_stracks, removed_stracks, img_width, img_height)
    ...
    def _prepare_output(self, activated_stracks, refind_stracks, lost_stracks, removed_stracks, img_width, img_height):
        self.active_tracks = [
        ...
        for t in self.active_tracks:
            if t.is_activated:
                ...
                outputs.append([x1, y1, x2, y2, t.id, t.conf, t.cls, t.det_ind])
