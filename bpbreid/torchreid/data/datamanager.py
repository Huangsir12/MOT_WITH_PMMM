...
from .masks_transforms import masks_preprocess_transforms
from .sampler import build_train_sampler
from .datasets import init_image_dataset, init_video_dataset, get_image_dataset
...
class ImageDataManager(DataManager):
    ...
    def __init__(
        ...
        for name in self.targets:
            ...
            if test_only:
                self._num_train_pids = galleryset.num_train_pids
                self._num_train_cams = galleryset.num_train_cams
