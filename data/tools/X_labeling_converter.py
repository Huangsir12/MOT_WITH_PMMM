...
def main():  # noqa: C901
    ...
    parser.add_argument("--src_path", default="data/datasets/Emporium/train/door1/gt.txt", help="Path to input file or directory")
    parser.add_argument("--dst_path", default="/data/datasets/gt.txt", help="Path to output file or directory")
